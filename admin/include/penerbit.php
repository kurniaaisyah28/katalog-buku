...
<section class="content">
  <div class="card">
    ...
    <div class="card-body">
      <div class="col-md-12">
        <form action="index.php?include=penerbit&aksi=cari" method="POST">
          <div class="row">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          $sql_p = "SELECT `p`.`id_penerbit` , `p`.`penerbit`, `p`.`alamat` FROM `penerbit` `p`";
          if (!empty($katakunci_kategori)) {
            $sql_p .= " where `penerbit` LIKE '%$katakunci_kategori%' ";
          }
          $sql_p .= "ORDER BY `p`.`penerbit` LIMIT $posisi, $batas";
          ...
          ?>
            <tr>
              ...
              <td align="center">
                <a href="index.php?include=edit-penerbit&data=<?php echo $id_penerbit; ?>" class="btn btn-xs btn-info" title="Edit"><i class="fas fa-edit"></i></a>
