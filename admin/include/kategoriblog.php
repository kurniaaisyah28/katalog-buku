...
<section class="content">
  <div class="card">
    ...
    <div class="card-body">
      <div class="col-md-12">
        <form action="index.php?include=kategori-blog&aksi=cari" method="post">
          <div class="row">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          $sql_kb = "SELECT `id_kategori_blog`, `kategori_blog` FROM `kategori_blog` ";
          if (!empty($katakunci_kategori)) {
            $sql_kb .= " where `kategori_blog` LIKE '%$katakunci_kategori%'";
          }
          $sql_kb .= " ORDER BY `kategori_blog` limit $posisi, $batas ";
          $query_kb = mysqli_query($koneksi, $sql_kb);
          $no = $posisi + 1;
          while ($data_kb = mysqli_fetch_row($query_kb)) {
            $id_kategori_blog = $data_kb[0];
            $kategori_blog = $data_kb[1];
          ?>
            <tr>
              <td><?php echo $no; ?></td>
