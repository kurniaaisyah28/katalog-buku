        ...
        <nav aria-label="Page navigation">
            ...
            <ul class="pagination">
                ...
                if ($jum_halaman == 0) {
                    ...
                    $setelah = $halaman + 1;
                    if ($halaman != 1) {
                        echo "<li class='page-item'><a class='page-link'href='daftar-buku-kategori-data-$data&halaman-1'>First</a></li>";
                        echo "<li class='page-item'><a class='page-link'href='daftar-buku-kategori-data-$data&halaman-$sebelum'>«</a></li>";
                    }
                    for ($i = 1; $i <= $jum_halaman; $i++) {
                        if ($i > $halaman - 5 and $i < $halaman + 5) {
                            if ($i != $halaman) {
                                echo "<li class='page-item'><a class='page-link' href='daftar-buku-kategori-data-$data-halaman-$i'>$i</a></li>";
                            } else {
                    ...
                    if ($halaman != $jum_halaman) {
                        echo "<li class='page-item'><a class='page-link' href='daftar-buku-kategori-data-$data&halaman-$setelah'>»</a></li>";
                        echo "<li class='page-item'><a class='page-link' href='daftar-buku-kategori-data-$data&halaman-$jum_halaman'>Last</a></li>";
                    }
                }
                ?>
            </ul>
