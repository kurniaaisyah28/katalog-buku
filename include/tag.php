        ...
        <ul class="pagination">
            ...
            for($i=1; $i<=$jum_halaman; $i++){
                if($i > $halaman - 5 and $i < $halaman + 5){
                    ...
                    echo "
                    <li class='page-item'>
                        <a class='page-link' href='daftar-buku-kategori-data-$data-halaman-$i'>$i</a>
                    </li>
                    ";
                    }else{
                    echo "
            ...
            if($halaman!=$jum_halaman){
                ...
                echo "<li class='page-item'><a class='page-link' href='aftar-buku-kategori-data-$data-halaman-$jum_halaman'>Last</a></li>";
                }
            }         
            ?>
        </ul>
