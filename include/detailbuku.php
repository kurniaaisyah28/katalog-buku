                    ...
                    <td>
                      ...
                      if (!empty($array_tag)) {
                        ...
                        for ($i = 0; $i < $jumlah_tag; $i++) {
                          if ($i == ($jumlah_tag - 1)) { ?>
                            <a href="daftar-buku-tag-<?php echo $array_idtag[$i]; ?>"><?php echo $array_tag[$i]; ?></a>
                          <?php
                          } else { ?>
          ...
          <aside class="col-md-3 katalog-sidebar">
            <div class="pl-4 pb-4">
              ...
              <ol class="list-unstyled mb-0">
                ...
                ?>
                  <li><a href="detail-buku-data-<?php echo $id_buku_terkait; ?>">
            ...
            <div class="pl-4 pb-4">
              ...
              <ol class="list-unstyled mb-0">
                ...
                while ($data_k = mysqli_fetch_row($query_k)) {
                  ...
                  $nama_kat = $data_k[1];
                ?>
                  <li><a href="daftar-buku-kategori-data-<?php echo $id_kat; ?>">
            ...
            <div class="p-4">
              ...
              <ol class="list-unstyled">
                ...
                while ($data_t = mysqli_fetch_row($query_t)) {
                  ...
                  $nama_tag = $data_t[1];
                ?>
                  <li><a href="daftar-buku-tag-data-<?php echo $id_tag; ?>">
