...
<section id="notes-item">
    <div class="container">
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading"><?php echo $judul_konten; ?></span></h2>
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body bg-warning">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group"><a href="detail-buku-data-<?php echo $id_buku;?>" class="btn btn-primary stretched-link">Detail</a></div>
                ...
                <div class="col-md-6">
                    <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        <div class="col p-4 d-flex flex-column position-static bg-light">
                            ...
                            <h3 class="mb-0"><a href="detail-blog-data-<?php echo $id_blog; ?>">
